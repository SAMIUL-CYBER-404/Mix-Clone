...
def o():
    ...
    if HASAN == 'B':
        ...
        return None
    if HASAN == 'C':
        os.system('xdg-open https://www.facebook.com/piccir.bo.90')
        return None
    if HASAN == 'D':
...
logo = ("""
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m Follow My Facebook Account & Github....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def Hasan():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45ŠH ŠHÃMÎUŁ)
